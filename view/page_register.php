	...
	<div class="container">
		<div class="form-row">
			...
			<div class="col-md-6">
				...
				<input class="form-control" type="form-control" type="text" name="name" required="true" autofocus="">
			</div>
			...
			<div class="col-md-4">
				...
				<input class="form-control" type="text" type="text" name="cpf" required="true" id="cpf" >
			</div>

			<div class="col-md-4">
				Dt. Nascimento: <i class="fa fa-calendar"></i>
				<input class="form-control" type="date" name="birth" required="true" >
			</div>
			...
			<div class="col-md-12">
				...
				<input class="form-control" type="text" name="address" required="true" id="phone">
			</div>
